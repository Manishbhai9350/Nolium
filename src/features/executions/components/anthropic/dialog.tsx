...
export type FormDataType = z.infer<typeof AnthropicFormSchema>;
...
const AnthropicDialog = ({
  ...
  const variableWatch = form.watch("variableName") || "myClaude";
  ...
  return (
    ...
    >
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Configure Anthropic (Claude)</DialogTitle>
          <DialogDescription>Use Anthropic AI Node to automated responses.</DialogDescription>
        </DialogHeader>
            ...
            {/* <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>The Gemini model to use</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            /> */}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Use{" "}
                    <code>{`{{${variableWatch || "myGeminiVariable"}}}`}</code>{" "}
                    to inject data
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Use{" "}
                    <code>{`{{${variableWatch || "myGeminiVariable"}.aiResponse}}`}</code>{" "}
